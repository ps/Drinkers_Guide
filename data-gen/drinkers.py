...
'''
Generates drinkers based on a first and last name list acquired from the internet, gender was included with first names.

Street names were generated by inputing first name into the Wu-Tang Name generator and pulling the result.

Other information involving numbers were generated using the random class.
'''
